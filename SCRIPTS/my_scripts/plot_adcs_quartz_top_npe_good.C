...
// Int_t run_num = 393;
  ...
  const TString adc_signals[nadcsignals] = {"PulseInt", "PulseAmp", "PulseTime"};
  const TString tdc_signals[ntdcsignals] = {"PulseTime", "TdcChan", "TdcTimeCorr", };
  ...
  formatit(histo7,40.,90.,"SHMS_Quartz_7T");
  c3->cd(2);
  //  formatit(histo8,80.,160.,"SHMS_Quartz_8B");
  formatit(histo8,50.,100.,"SHMS_Quartz_8T");
  c3->cd(3);
  //  formatit(histo9,40.,85,"SHMS_Quartz_9B");
  formatit(histo9,35.,90,"SHMS_Quartz_9T");
  c3->cd(4);
  //  formatit(histo10,60.,160.,"SHMS_Quartz_10B");
  formatit(histo10,40.,100.,"SHMS_Quartz_10T");
  c3->cd(5);
  //  formatit(histo11,58.,120.,"SHMS_Quartz_11B");   
  formatit(histo11,42.,120.,"SHMS_Quartz_11T");   
  c3->cd(6);
  //  formatit(histo12,40,90,"SHMS_Quartz_12B");
  formatit(histo12,30,80,"SHMS_Quartz_12T");
  c3->cd(7);
  //  formatit(histo13,40,100,"SHMS_Quartz_13B");
  formatit(histo13,30,80,"SHMS_Quartz_13T");
  c3->cd(8);
  ...
  c3->Print("464_fresh_quartz_pint_npe_top_good.png");
  c3->Print("464_fresh_replay_quartz_pint_npe_top_good.pdf");
