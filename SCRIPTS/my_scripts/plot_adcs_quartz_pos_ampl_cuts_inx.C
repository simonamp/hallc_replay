...
int main(){
  ...
  c3->cd(1);
  formatit(histo7,110.,340.,"SHMS_S2Y_7Pos"); // less than
  //formatit(histo7,170.,420.,"SHMS_S2Y_7Pos"); // more than

  c3->cd(2);
  formatit(histo8,60.,200.,"SHMS_S2Y_8Pos"); // less than
  //formatit(histo8,110.,470.,"SHMS_S2Y_8Pos"); // more than

  c3->cd(3);
  formatit(histo9,75.,280,"SHMS_S2Y_9Pos"); // less than
  //formatit(histo9,110.,330,"SHMS_S2Y_9Pos"); // more than

  c3->cd(4);
  formatit(histo10,40.,280.,"SHMS_S2Y_10Pos"); // less than
  //formatit(histo10,20.,480.,"SHMS_S2Y_10Pos"); // more than

  c3->cd(5);
  formatit(histo11,120.,340.,"SHMS_S2Y_11Pos"); // less than   
  //formatit(histo11,140.,380.,"SHMS_S2Y_11Pos"); // more than   

  c3->cd(6);
  formatit(histo12,120,330,"SHMS_S2Y_12Pos"); // less than
  //formatit(histo12,140,420,"SHMS_S2Y_12Pos"); // more than

  c3->cd(7);
  formatit(histo13,100,300,"SHMS_S2Y_13Pos"); // less than
  //formatit(histo11,130,380,"SHMS_S2Y_13Pos"); // more than

  c3->cd(8);
  formatit(histo14,110,360,"SHMS_S2Y_14Pos"); // less than
  //formatit(histo14,230,600,"SHMS_S2Y_14Pos"); // more than

  c3->cd(9);
  formatit(histo15,110,270,"SHMS_S2Y_15Pos"); // less than
  //formatit(histo15,200,650,"SHMS_S2Y_15Pos"); // more than

  c3->Print("488_fresh_quartz_pint_ampl_pos_withc_xlt0.png");
  c3->Print("488_fresh_replay_quartz_pint_ampl_pos_withc_xlt0.pdf");
