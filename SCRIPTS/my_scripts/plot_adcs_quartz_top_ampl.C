...
TFile *myfile;
  ...
  c3->Divide(3,3);
  c3->cd(1);
  formatit(histo7,160.,400.,"SHMS_Quartz_7T");
  c3->cd(2);
  formatit(histo8,80.,250.,"SHMS_Quartz_8T");
  c3->cd(3);
  formatit(histo9,100.,260.,"SHMS_Quartz_9T");
  c3->cd(4);
  formatit(histo10,200.,380.,"SHMS_Quartz_10T");
  c3->cd(5);
  formatit(histo11,180.,400.,"SHMS_Quartz_11T");   
  c3->cd(6);
  formatit(histo12,100.,300.,"SHMS_Quartz_12T");
  c3->cd(7);
  formatit(histo13,100.,320.,"SHMS_Quartz_13T");
  c3->cd(8);
  formatit(histo14,100.,300.,"SHMS_Quartz_14T");
  c3->cd(9);
  formatit(histo15,2.5,8.5,"SHMS_Quartz_15T"); 

  c3->Print("393_quartz_amp_top.png");
