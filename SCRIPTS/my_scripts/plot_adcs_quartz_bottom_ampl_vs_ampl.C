...
TFile *myfile;
  ...
  TH2F *histo7 = new TH2F("SHMS_Quartz_pos_7","",1000,0,200.,1000,0,200.);      
  TH2F *histo8 = new TH2F("SHMS_Quartz_pos_8","",1000,0,200.,1000,0,200.);      
  TH2F *histo9 = new TH2F("SHMS_Quartz_pos_9","",1000,0,200.,1000,0,200.);      
  TH2F *histo10 = new TH2F("SHMS_Quartz_pos_10","",1000,0,200.,1000,0,200.);      
  TH2F *histo11 = new TH2F("SHMS_Quartz_pos_11","",1000,0,200.,1000,0,200.);      
  TH2F *histo12 = new TH2F("SHMS_Quartz_pos_12","",1000,0,200.,1000,0,200.);      
  TH2F *histo13 = new TH2F("SHMS_Quartz_pos_13","",1000,0,200.,1000,0,200.);      
  TH2F *histo14 = new TH2F("SHMS_Quartz_pos_14","",1000,0,200.,1000,0,200.);      
  TH2F *histo15 = new TH2F("SHMS_Quartz_pos_15","",1000,0,200.,1000,0,200.);      
  ...
  //  for(Int_t i=0; i < 2000; i++){
	...
	for(Int_t adc1_ihit = 0; adc1_ihit < nadchits[ip][1]; adc1_ihit++)  {
	  ...
	  if (adc1bar == 6){
	    Int_t countit = 0;
	    Double_t adc1val = 0.;
	    Double_t adc1val = adc_values[ip][1][0][adc1_ihit]*0.1;
	    
	    for(Int_t adc2_ihit = 0; adc2_ihit < nadchits[ip][0]; adc2_ihit++)  {
	      UInt_t adc2bar = TMath::Nint(adc_paddles[ip][0][adc2_ihit]) - 1;
	      if (adc2bar == 6){
		Double_t adc2val = 0.;
		Double_t adc2val = adc_values[ip][0][0][adc2_ihit]*0.1;
		Double_t diff_pos_neg = adc1val - adc2val;
		histo7->Fill(adc2val,adc1val);
		//	      cout << " " << adc2val << " " << diff_pos_neg << endl;
		countit++;
  ...
  c3->Divide(3,3);
  c3->cd(1);
  formatit(histo7,0.,200.,"SHMS_Quartz_7");
  c3->cd(2);
  formatit(histo8,0.,200.,"SHMS_Quartz_8");
  c3->cd(3);
  formatit(histo9,0.,200.,"SHMS_Quartz_9");
  c3->cd(4);
  formatit(histo10,0.,200.,"SHMS_Quartz_10");
  c3->cd(5);
  formatit(histo11,0.,200.,"SHMS_Quartz_11");   
  c3->cd(6);
  formatit(histo12,0.,200.,"SHMS_Quartz_12");
  c3->cd(7);
  formatit(histo13,0.,200.,"SHMS_Quartz_13");
  c3->cd(8);
  formatit(histo14,0.,200.,"SHMS_Quartz_14");
  c3->cd(9);
  formatit(histo15,0,200,"SHMS_Quartz_15"); 

  c3->Print("461_quartz_adc_adc_bottom.png");
  c3->Print("461_quartz_adc_adc_bottom.pdf"); 
