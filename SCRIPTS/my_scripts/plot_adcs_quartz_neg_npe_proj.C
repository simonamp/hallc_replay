...
// Int_t run_num = 393;
  ...
  TH2F *histo7 = new TH2F("SHMS_Quartz_neg_7","",280,-70.,70.,120,-30.,30.);      
  TH2F *histo8 = new TH2F("SHMS_Quartz_neg_8","",280,-70.,70.,120,-30.,30.);      
  TH2F *histo9 = new TH2F("SHMS_Quartz_neg_9","",280,-70.,70.,120,-30.,30.);      
  TH2F *histo10 = new TH2F("SHMS_Quartz_neg_10","",280,-70.,70.,120,-30.,30.);      
  TH2F *histo11 = new TH2F("SHMS_Quartz_neg_11","",280,-70.,70.,120,-30.,30.);      
  TH2F *histo12 = new TH2F("SHMS_Quartz_neg_12","",280,-70.,70.,120,-30.,30.);      
  TH2F *histo13 = new TH2F("SHMS_Quartz_neg_13","",280,-70.,70.,120,-30.,30.);      
  TH2F *histo14 = new TH2F("SHMS_Quartz_neg_14","",280,-70.,70.,120,-30.,30.);      
  TH2F *histo15 = new TH2F("SHMS_Quartz_neg_15","",280,-70.,70.,120,-30.,30.);      
	...
	if (ip == 3){
	  ...
	  for(Int_t adc1_ihit = 0; adc1_ihit < nadchits[ip][0]; adc1_ihit++)  {
	    ...
	    if (adc1bar == 6){
	      ...
	      countit6++;
	      if (countit6 > 1){
		cout << "2 adc hits per PMT bar 6??? " << " " << countit6 << endl;
		  }
	    } else if (adc1bar == 7){
	      ...
	      countit7++;
	      if (countit7 > 1){
		cout << "2 adc hits per PMT in bar 7??? " << " " << countit7 << endl;
		  }
	    } else if (adc1bar == 8){
	      ...
	      countit8++;
	      if (countit8 > 1){
		cout << "2 adc hits per PMT in bar 8??? " << " " << countit8 << endl;
		  }
  ...
  //  c3->Print("488_fresh_quartz_pint_npe_neg_weight.png");
  //  c3->Print("488_fresh_replay_quartz_pint_npe_neg_weight.pdf");
