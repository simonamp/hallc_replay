...
// Int_t run_num = 393;
  ...
  formatit(histo7,45.,125.,"SHMS_Quartz_7Pos");
  c3->cd(2);
  //  formatit(histo8,80.,160.,"SHMS_Quartz_8Pos");
  formatit(histo8,10.,70.,"SHMS_Quartz_8Pos");
  c3->cd(3);
  //  formatit(histo9,40.,85,"SHMS_Quartz_9Pos");
  formatit(histo9,42.,128,"SHMS_Quartz_9Pos");
  c3->cd(4);
  //  formatit(histo10,60.,160.,"SHMS_Quartz_10Pos");
  formatit(histo10,22.,133.,"SHMS_Quartz_10Pos");
  c3->cd(5);
  //  formatit(histo11,58.,120.,"SHMS_Quartz_11Pos");   
  formatit(histo11,45.,118.,"SHMS_Quartz_11Pos");   
  c3->cd(6);
  //  formatit(histo12,40,90,"SHMS_Quartz_12Pos");
  formatit(histo12,38,135,"SHMS_Quartz_12Pos");
  c3->cd(7);
  //  formatit(histo13,40,100,"SHMS_Quartz_13Pos");
  formatit(histo13,30,130,"SHMS_Quartz_13Pos");
  c3->cd(8);
  //  formatit(histo14,40,95,"SHMS_Quartz_14Pos");
  formatit(histo14,40,165,"SHMS_Quartz_14Pos");
  c3->cd(9);
  formatit(histo15,40,120,"SHMS_Quartz_15Pos"); 

  c3->Print("488_fresh_quartz_pint_npe_pos_withc.png");
  c3->Print("488_fresh_replay_quartz_pint_npe_pos_withc.pdf");
