...
// Int_t run_num = 393;
  ...
  c3->Divide(3,3);
  c3->cd(1);
  //  formatit(histo7,60.,130.,"SHMS_Quartz_7Neg");
  formatit(histo7,75.,160.,"SHMS_Quartz_7Neg");
  c3->cd(2);
  //  formatit(histo8,80.,160.,"SHMS_Quartz_8Neg");
  formatit(histo8,75.,150.,"SHMS_Quartz_8Neg");
  c3->cd(3);
  //  formatit(histo9,40.,85,"SHMS_Quartz_9Neg");
  formatit(histo9,40.,120,"SHMS_Quartz_9Neg");
  c3->cd(4);
  //  formatit(histo10,60.,160.,"SHMS_Quartz_10Neg");
  formatit(histo10,40.,120.,"SHMS_Quartz_10Neg");
  c3->cd(5);
  //  formatit(histo11,58.,120.,"SHMS_Quartz_11Neg");   
  formatit(histo11,55.,165.,"SHMS_Quartz_11Neg");   
  c3->cd(6);
  //  formatit(histo12,40,90,"SHMS_Quartz_12Neg");
  formatit(histo12,50,155,"SHMS_Quartz_12Neg");
  c3->cd(7);
  //  formatit(histo13,40,100,"SHMS_Quartz_13Neg");
  formatit(histo13,30,90,"SHMS_Quartz_13Neg");
  c3->cd(8);
  //  formatit(histo14,40,95,"SHMS_Quartz_14Neg");
  formatit(histo14,50,190,"SHMS_Quartz_14Neg");
  c3->cd(9);
  formatit(histo15,25,85,"SHMS_Quartz_15Neg"); 

  c3->Print("488_fresh_quartz_pint_npe_neg.png");
  c3->Print("488_fresh_replay_quartz_pint_npe_neg.pdf");
