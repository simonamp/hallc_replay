...
int main(){
  ...
  c3->cd(1);
  formatit(histo7,histo7in,histo7yc,30.,190.,"SHMS_S2Y_7Neg"); // less than
  //formatit(histo7,7.,100.,"SHMS_S2Y_7Neg"); // more than

  c3->cd(2);
  formatit(histo8,histo8in,histo8yc,70.,155.,"SHMS_S2Y_8Neg"); // less than
  //formatit(histo8,48.,140.,"SHMS_S2Y_8Neg"); // more than

  c3->cd(3);
  formatit(histo9,histo9in,histo9yc,20.,140,"SHMS_S2Y_9Neg"); // less than
  //formatit(histo9,9.,90,"SHMS_S2Y_9Neg"); // more than

  c3->cd(4);
  formatit(histo10,histo10in,histo10yc,25.,160.,"SHMS_S2Y_10Neg"); // less than
  //formatit(histo10,20.,128.,"SHMS_S2Y_10Neg"); // more than

  c3->cd(5);
  formatit(histo11,histo11in,histo11yc,68.,180.,"SHMS_S2Y_11Neg"); // less than   
  //formatit(histo11,50.,154.,"SHMS_S2Y_11Neg"); // more than   

  c3->cd(6);
  formatit(histo12,histo12in,histo12yc,70,170,"SHMS_S2Y_12Neg"); // less than
  //formatit(histo12,50,144,"SHMS_S2Y_12Neg"); // more than

  c3->cd(7);
  formatit(histo13,histo13in,histo13yc,35,88,"SHMS_S2Y_13Neg"); // less than
  //formatit(histo13,23,70,"SHMS_S2Y_13Neg"); // more than

  c3->cd(8);
  formatit(histo14,histo14in,histo14yc,100,210,"SHMS_S2Y_14Neg"); // less than
  //formatit(histo14,45,148,"SHMS_S2Y_14Neg"); // more than

  c3->cd(9);
  formatit(histo15,histo15in,histo15yc,40,185,"SHMS_S2Y_15Neg"); // less than
  //formatit(histo15,15,105,"SHMS_S2Y_15Neg"); // more than

  c3->Print("488_fresh_quartz_pint_adcrawtime_neg_withc_xgt0_noneiny_ellip_cut_andycut.png");
  c3->Print("488_fresh_replay_quartz_pint_adcrawtime_neg_withc_xgt0_noneiny_ellip_cut_andycut.pdf");
