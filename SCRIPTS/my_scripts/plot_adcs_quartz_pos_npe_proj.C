...
// Int_t run_num = 393;
  ...
  TH2F *histo7 = new TH2F("SHMS_Quartz_pos_7","",280,-70.,70.,120,-30.,30.);      
  TH2F *histo8 = new TH2F("SHMS_Quartz_pos_8","",280,-70.,70.,120,-30.,30.);      
  TH2F *histo9 = new TH2F("SHMS_Quartz_pos_9","",280,-70.,70.,120,-30.,30.);      
  TH2F *histo10 = new TH2F("SHMS_Quartz_pos_10","",280,-70.,70.,120,-30.,30.);      
  TH2F *histo11 = new TH2F("SHMS_Quartz_pos_11","",280,-70.,70.,120,-30.,30.);      
  TH2F *histo12 = new TH2F("SHMS_Quartz_pos_12","",280,-70.,70.,120,-30.,30.);      
  TH2F *histo13 = new TH2F("SHMS_Quartz_pos_13","",280,-70.,70.,120,-30.,30.);      
  TH2F *histo14 = new TH2F("SHMS_Quartz_pos_14","",280,-70.,70.,120,-30.,30.);      
  TH2F *histo15 = new TH2F("SHMS_Quartz_pos_15","",280,-70.,70.,120,-30.,30.);      
  //  TH2F *histo7nw = new TH2F("SHMS_Quartz_pos_7","",280,-70.,70.,120,-30.,30.);      
  /*  TH2F *histo8nw = new TH2F("SHMS_Quartz_pos_8","",1000,-200.,200.,1000,-200.,200.);      
  TH2F *histo9nw = new TH2F("SHMS_Quartz_pos_9","",1000,-200.,200.,1000,-200.,200.);      
  TH2F *histo10nw = new TH2F("SHMS_Quartz_pos_10","",1000,-200.,200.,1000,-200.,200.);      
  TH2F *histo11nw = new TH2F("SHMS_Quartz_pos_11","",1000,-200.,200.,1000,-200.,200.);      
  TH2F *histo12nw = new TH2F("SHMS_Quartz_pos_12","",1000,-200.,200.,1000,-200.,200.);      
  TH2F *histo13nw = new TH2F("SHMS_Quartz_pos_13","",1000,-200.,200.,1000,-200.,200.);      
  TH2F *histo14nw = new TH2F("SHMS_Quartz_pos_14","",1000,-200.,200.,1000,-200.,200.);      
  TH2F *histo15nw = new TH2F("SHMS_Quartz_pos_15","",1000,-200.,200.,1000,-200.,200.);      */
	...
	if (ip == 3){
	  ...
	  for(Int_t adc1_ihit = 0; adc1_ihit < nadchits[ip][1]; adc1_ihit++)  {
	    ...
	    if (adc1bar == 6){
	      ...
	      histo7->Fill(xis,yis,adc1val);
	      //	      histo7nw->Fill(xis,yis);
	      //	      histo7->Divide(histo7nw);
	    } else if (adc1bar == 7){
	      Double_t adc1val = 0.;
	      Double_t xis = 0;
	      Double_t yis = 0;
  ...
  formatit(histo7,45.,120.,"SHMS_Quartz_7Pos");
  c3->cd(2);
  //  formatit(histo8,80.,160.,"SHMS_Quartz_8Pos");
  formatit(histo8,25.,60.,"SHMS_Quartz_8Pos");
  c3->cd(3);
  //  formatit(histo9,40.,85,"SHMS_Quartz_9Pos");
  formatit(histo9,42.,120,"SHMS_Quartz_9Pos");
  c3->cd(4);
  //  formatit(histo10,60.,160.,"SHMS_Quartz_10Pos");
  formatit(histo10,30.,110.,"SHMS_Quartz_10Pos");
  c3->cd(5);
  //  formatit(histo11,58.,120.,"SHMS_Quartz_11Pos");   
  formatit(histo11,45.,110.,"SHMS_Quartz_11Pos");   
  c3->cd(6);
  //  formatit(histo12,40,90,"SHMS_Quartz_12Pos");
  formatit(histo12,38,130,"SHMS_Quartz_12Pos");
  c3->cd(7);
  //  formatit(histo13,40,100,"SHMS_Quartz_13Pos");
  formatit(histo13,40,125,"SHMS_Quartz_13Pos");
  c3->cd(8);
  //  formatit(histo14,40,95,"SHMS_Quartz_14Pos");
  formatit(histo14,50,150,"SHMS_Quartz_14Pos");
  c3->cd(9);
  formatit(histo15,25,85,"SHMS_Quartz_15Pos"); 

  c3->Print("488_fresh_quartz_pint_npe_pos_weight.png");
  c3->Print("488_fresh_replay_quartz_pint_npe_pos_weight.pdf");
