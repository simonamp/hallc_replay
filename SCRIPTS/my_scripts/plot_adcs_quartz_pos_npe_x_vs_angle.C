...
// Int_t run_num = 393;
  ...
  TH2F *histo7 = new TH2F("SHMS_Quartz_neg_7","",280,-70.,70.,100,-0.4.,0.4);      
  TH2F *histo8 = new TH2F("SHMS_Quartz_neg_8","",280,-70.,70.,100,-0.4,0.4);      
  TH2F *histo9 = new TH2F("SHMS_Quartz_neg_9","",280,-70.,70.,100,-0.4,0.4);      
  TH2F *histo10 = new TH2F("SHMS_Quartz_neg_10","",280,-70.,70.,100,-0.4,0.4);      
  TH2F *histo11 = new TH2F("SHMS_Quartz_neg_11","",280,-70.,70.,100,-0.4,0.4);      
  TH2F *histo12 = new TH2F("SHMS_Quartz_neg_12","",280,-70.,70.,100,-0.4,0.4);      
  TH2F *histo13 = new TH2F("SHMS_Quartz_neg_13","",280,-70.,70.,100,-0.4,0.4);      
  TH2F *histo14 = new TH2F("SHMS_Quartz_neg_14","",280,-70.,70.,100,-0.4,0.4);      
  TH2F *histo15 = new TH2F("SHMS_Quartz_neg_15","",280,-70.,70.,100,-0.4,0.4);      
	...
	if (ip == 3){
	  ...
	  for(Int_t adc1_ihit = 0; adc1_ihit < nadchits[ip][1]; adc1_ihit++)  {
	    ...
	    if (adc1bar == 6){
	      ...
	      histo7->Fill(xis,track_xp[0],adc1val);
	      ...
	      Double_t xis = track_x[0] + track_xp[0] * 276.35;
	      Double_t yis = track_y[0] + track_yp[0] * 276.35;
	      histo8->Fill(xis,track_xp[0],adc1val);
	      ...
	      Double_t xis = track_x[0] + track_xp[0] * 276.35;
	      Double_t yis = track_y[0] + track_yp[0] * 276.35;
	      histo9->Fill(xis,track_xp[0],adc1val);
	    } else if (adc1bar == 9){
	      Double_t adc1val = 0.;
	      Double_t xis = 0;
	      Double_t yis = 0;
	      ...
	      Double_t xis = track_x[0] + track_xp[0] * 276.35;
	      Double_t yis = track_y[0] + track_yp[0] * 276.35;
	      histo10->Fill(xis,track_xp[0],adc1val);
	    } else if (adc1bar == 10){
	      Double_t adc1val = 0.;
	      Double_t xis = 0;
	      Double_t yis = 0;
	      ...
	      Double_t xis = track_x[0] + track_xp[0] * 276.35;
	      Double_t yis = track_y[0] + track_yp[0] * 276.35;
	      histo11->Fill(xis,track_xp[0],adc1val);
	    } else if (adc1bar == 11){
	      Double_t adc1val = 0.;
	      Double_t xis = 0;
	      Double_t yis = 0;
	      ...
	      Double_t xis = track_x[0] + track_xp[0] * 276.35;
	      Double_t yis = track_y[0] + track_yp[0] * 276.35;
	      histo12->Fill(xis,track_xp[0],adc1val);
	    } else if (adc1bar == 12){
	      Double_t adc1val = 0.;
	      Double_t xis = 0;
	      Double_t yis = 0;
	      ...
	      Double_t xis = track_x[0] + track_xp[0] * 276.35;
	      Double_t yis = track_y[0] + track_yp[0] * 276.35;
	      histo13->Fill(xis,track_xp[0],adc1val);
	    } else if (adc1bar == 13){
	      Double_t adc1val = 0.;
	      Double_t xis = 0;
	      Double_t yis = 0;
	      ...
	      Double_t xis = track_x[0] + track_xp[0] * 276.35;
	      Double_t yis = track_y[0] + track_yp[0] * 276.35;
	      histo14->Fill(xis,track_xp[0],adc1val);
	    } else if (adc1bar == 14){
	      Double_t adc1val = 0.;
	      Double_t xis = 0;
	      Double_t yis = 0;
	      ...
	      Double_t xis = track_x[0] + track_xp[0] * 276.35;
	      Double_t yis = track_y[0] + track_yp[0] * 276.35;
	      histo15->Fill(xis,track_xp[0],adc1val);
	    } 
	    else{
	    }; 
	  }
  ...
  c3->Print("488_fresh_quartz_pint_npe_pos_x_vs_angle.png");
  c3->Print("488_fresh_replay_quartz_pint_npe_pos_x_vs_angle.pdf");
