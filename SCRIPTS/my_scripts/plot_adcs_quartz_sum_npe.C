...
// Int_t run_num = 393;
  ...
  TH1F *histo7 = new TH1F("SHMS_Quartz_pos_7","",1000,0.,200.);      
  TH1F *histo8 = new TH1F("SHMS_Quartz_pos_8","",1000,0.,200.);      
  TH1F *histo9 = new TH1F("SHMS_Quartz_pos_9","",1000,0.,200.);      
  TH1F *histo10 = new TH1F("SHMS_Quartz_pos_10","",1000,0.,200.);      
  TH1F *histo11 = new TH1F("SHMS_Quartz_pos_11","",1000,0.,200.);      
  TH1F *histo12 = new TH1F("SHMS_Quartz_pos_12","",1000,0.,200.);      
  TH1F *histo13 = new TH1F("SHMS_Quartz_pos_13","",1000,0.,200.);      
  TH1F *histo14 = new TH1F("SHMS_Quartz_pos_14","",1000,0.,200.);      
  TH1F *histo15 = new TH1F("SHMS_Quartz_pos_15","",1000,0.,200.);      
  ...
  //  for(Int_t i=0; i < 400000; i++){
	...
	if (nTracksx == 1 && nTracksy ==1 && ip == 3 && adc1bar == 6){
	  Double_t adc1val = 0.;
	  Double_t adc2val = 0.;
	  Double_t adc1val = adc_values[ip][0][2][adc1_ihit] * 0.02;
	  Double_t adc2val = adc_values[ip][1][2][adc1_ihit] * 0.02;
	  histo7->Fill(adc1val);
	} else if (nTracksx == 1 && nTracksy ==1 && ip == 3 && adc1bar == 7){
	  Double_t adc1val = 0.;
	  adc1val = adc_values[ip][0][2][adc1_ihit] * 0.02;
	  histo8->Fill(adc1val);
	} else if (nTracksx == 1 && nTracksy ==1 && ip == 3 && adc1bar == 8){
	  Double_t adc1val = 0.;
	  adc1val = adc_values[ip][0][2][adc1_ihit] * 0.02;
	  histo9->Fill(adc1val);
	} else if (nTracksx == 1 && nTracksy ==1 && ip == 3 && adc1bar == 9){
	  Double_t adc1val = 0.;
	  adc1val = adc_values[ip][0][2][adc1_ihit] * 0.02;
	  histo10->Fill(adc1val);
	} else if (nTracksx == 1 && nTracksy ==1 && ip == 3 && adc1bar == 10){
	  Double_t adc1val = 0.;
	  adc1val = adc_values[ip][0][2][adc1_ihit] * 0.02;
	  histo11->Fill(adc1val);
	} else if (nTracksx == 1 && nTracksy ==1 && ip == 3 && adc1bar == 11){
	  Double_t adc1val = 0.;
	  adc1val = adc_values[ip][0][2][adc1_ihit] * 0.02;
	  histo12->Fill(adc1val);
	} else if (nTracksx == 1 && nTracksy ==1 && ip == 3 && adc1bar == 12){
	  Double_t adc1val = 0.;
	  adc1val = adc_values[ip][0][2][adc1_ihit] * 0.02;
	  histo13->Fill(adc1val);
	} else if (nTracksx == 1 && nTracksy ==1 && ip == 3 && adc1bar == 13){
	  Double_t adc1val = 0.;
	  adc1val = adc_values[ip][0][2][adc1_ihit] * 0.02;
	  histo14->Fill(adc1val);
	} else if (nTracksx == 1 && nTracksy ==1 && ip == 3 && adc1bar == 14){
	    Double_t adc1val = 0.;
	    adc1val = adc_values[ip][0][2][adc1_ihit] * 0.02;
  ...
  c3->Divide(3,3);
  c3->cd(1);
  //  formatit(histo7,60.,130.,"SHMS_Quartz_7B");
  formatit(histo7,60.,155.,"SHMS_Quartz_7T");
  c3->cd(2);
  //  formatit(histo8,80.,160.,"SHMS_Quartz_8B");
  formatit(histo8,65.,150.,"SHMS_Quartz_8T");
  c3->cd(3);
  //  formatit(histo9,40.,85,"SHMS_Quartz_9B");
  formatit(histo9,60.,140,"SHMS_Quartz_9T");
  c3->cd(4);
  //  formatit(histo10,60.,160.,"SHMS_Quartz_10B");
  formatit(histo10,45.,140.,"SHMS_Quartz_10T");
  c3->cd(5);
  //  formatit(histo11,58.,120.,"SHMS_Quartz_11B");   
  formatit(histo11,60.,160.,"SHMS_Quartz_11T");   
  c3->cd(6);
  //  formatit(histo12,40,90,"SHMS_Quartz_12B");
  formatit(histo12,55,160,"SHMS_Quartz_12T");
  c3->cd(7);
  //  formatit(histo13,40,100,"SHMS_Quartz_13B");
  formatit(histo13,30,100,"SHMS_Quartz_13T");
  c3->cd(8);
  //  formatit(histo14,40,95,"SHMS_Quartz_14B");
  formatit(histo14,30,80,"SHMS_Quartz_14T");
  c3->cd(9);
  formatit(histo15,25,85,"SHMS_Quartz_15T"); 

  c3->Print("488_fresh_quartz_pint_npe_top.png");
  c3->Print("488_fresh_replay_quartz_pint_npe_top.pdf");
