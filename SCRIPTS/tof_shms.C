void tof_shms() {
  ...
  TFile F("../ROOTfiles/shms_replay_488_-1_bc.root");
  TTree* T = F.Get("T");
  ...
  T->SetBranchAddress("P.hod.1x.fptime", &fptime_1x);
  T->SetBranchAddress("P.hod.2x.fptime", &fptime_2x);
  T->SetBranchAddress("P.hod.1y.fptime", &fptime_1y);
  T->SetBranchAddress("P.hod.2y.fptime", &fptime_2y);
  T->SetBranchAddress("P.hod.beta", &gtrbeta);
  T->SetBranchAddress("P.hod.betanotrack", &betanotrk);

  TH1F *fp1x = new TH1F("fpt1x", "", 200, 0., 100);
  TH1F *fp2x = new TH1F("fpt2x", "", 200, 0., 100);
  TH1F *fp1y = new TH1F("fpt1y", "", 200, 0., 100);
  TH1F *fp2y = new TH1F("fpt2y", "", 200, 0., 100);

  TH1F *beta = new TH1F("betais", "", 300, 0.1, 1.4);
  TH1F *betant = new TH1F("betaisnt", "", 300, 0.1, 1.4);
  ...
  c1->Print("tof_fptime_bc_tol_100_shms.pdf");
  ...
  TF1 *gaus = new TF1("gaus","gaus",0.87,1.04);
  //  TF1 *gaus = new TF1("gaus","gaus",0.878,1.118);
  ...
  c2->Print("tof_beta_bc_tol_100_shms.pdf");
  ...
  TF1 *gausn = new TF1("gausn","gaus",0.84,1.06);
  //  TF1 *gausn = new TF1("gausn","gaus",0.88,1.118);
  ...
  c3->Print("tof_betant_bc_tol_100_shms.pdf");
